...
! function () {
    window.HE = {
        config: {
            ...
            autoHeight: 1,
            uploadPhoto: 1,
            uploadPhotoHandler: "/admin/uploadphoto",
            uploadPhotoSize: 1000,
            uploadPhotoType: "gif,png,jpg,jpeg",
            uploadPhotoTypeError: "只能上传图片文件",
            uploadPhotoSizeError: "上传的图片文件超过允许的大小",
            uploadParam: {},
            item: ["bold", "italic", "strike", "underline", "fontSize", "fontName", "paragraph", "color", "backColor", "|", "center", "left", "right", "full", "indent", "outdent", "|", "link", "unlink", "textBlock", "code", "selectAll", "removeFormat", "trash", "|", "image", "subscript", "superscript", "horizontal", "orderedList", "unorderedList", "|", "undo", "redo", "|", "html", "|", "about"]
        },
        define: {
            version: "1.6.5",
            click: "",
        ...
        editorClick: function () {
            ...
            if (n.length > 0)
                for (var a in n) e = document.getElementById(HE.getId(n[a])), HE.hasClass(e, "HandyEditor_menu_item_valid") || HE.addClass(e, "HandyEditor_menu_item_valid");
            HE.sarea()
        },
